...
public class ClientGUI extends JFrame implements MessageListener {
    ...
    private JPanel createdChatMessageComponent(Message message) {
    ...
    public void onMessageReceived(Message message) {
        System.out.println("onMessageReceived: " + message.getUser() + " - " + message.getMessage());
        messagePanel.add(createdChatMessageComponent(message));
        updateMessageSize();
        revalidate();
        repaint();
